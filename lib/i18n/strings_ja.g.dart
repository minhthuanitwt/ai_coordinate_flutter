...
class _TranslationsCoordinateJa extends TranslationsCoordinateEn {
	...
	// Translations
	@override String get coordinate_page_title => 'コーディネート';
	@override String get coordinate_page_subtitle => '参照画像ベースで生成し、進行状況をリアルタイムで確認できます。';
	@override String get generation_section_title => '生成';
	@override String get results_section_title => '生成結果';
	@override String get progress_section_title => '生成進行';
	@override String get source_mode_upload => 'アップロード';
	@override String get source_mode_stock => 'ストック';
	@override String get upload_library_title => 'ソース画像アップロード';
	@override String get upload_library_action => 'ライブラリから選択';
	@override String get upload_library_loading => 'ライブラリを開いています...';
	@override String get upload_none_selected => 'アップロード未選択';
	@override String get stock_picker_title => 'ストック画像を選択';
	@override String get prompt_input_label => 'プロンプト';
	@override String get prompt_input_hint => '生成したい衣装・スタイル変更内容を入力してください';
	@override String get source_type_label => 'ソース画像タイプ';
	@override String get source_type_illustration => 'イラスト';
	@override String get source_type_real => '実写';
	@override String get background_label => '背景モード';
	@override String get background_keep => '背景を維持';
	@override String get background_include => '背景をプロンプトに含める';
	@override String get background_auto => 'AI自動背景';
	@override String get model_tier_label => '生成モデルを選択';
	@override String get model_tier_light => '軽量モデル：Nano Banana 2 | 0.5K（10ペルコイン/枚）';
	@override String get model_tier_standard => '標準モデル：Nano Banana 2 | 1K（20ペルコイン/枚）';
	@override String get model_tier_pro1k => '高精細モデル：Nano Banana Pro | 1K（50ペルコイン/枚）';
	@override String get model_tier_pro2k => '高精細モデル：Nano Banana Pro | 2K（80ペルコイン/枚）';
	@override String get model_tier_pro4k => '高精細モデル：Nano Banana Pro | 4K（100ペルコイン/枚）';
	@override String get output_count_label => '出力枚数';
	@override String get estimated_cost_label => '想定コスト: {{amount}} percoins • 残高: {{balance}}';
	@override String get plan_limit_notice => '現在のプランでは1回の生成で最大{{max}}枚までです。';
	@override String get generating_button_ready => '生成する';
	@override String get generating_button_loading => '生成中...';
	@override String get balance_chip => '残高: {{amount}}';
	@override String get buy_percoins_action => 'Percoinsを購入';
	@override String get still_processing_notice => 'バックグラウンドで処理中です。Coordinateを再表示すると自動で追跡を再開します。';
	@override String get status_queued => 'キュー待ち';
	@override String get status_processing => '処理中';
	@override String get status_charging => '課金処理中';
	@override String get status_generating => '画像生成中';
	@override String get status_uploading => 'アップロード中';
	@override String get status_persisting => '保存中';
	@override String get status_completed => '完了';
	@override String get status_failed => '失敗';
	@override String get error_missing_prompt => '生成前にプロンプトを入力してください。';
	@override String get error_prompt_too_long => 'プロンプトが上限を超えています。';
	@override String get error_missing_source => '生成前にソース画像を選択してください。';
	@override String get error_unsupported_upload => 'アップロード対応形式は JPG/PNG/WebP のみです。';
	@override String get error_upload_too_large => 'アップロードサイズは10MB以下にしてください。';
	@override String get error_upgrade_required => '選択した枚数は現在のプラン上限を超えています。';
	@override String get error_insufficient_balance => 'このリクエストに必要な percoins が不足しています。';
	@override String get error_submit_failed => '現在生成リクエストを送信できません。';
	@override String get error_history_failed => '生成履歴を読み込めませんでした。';
	@override String get error_polling_failed => '生成進捗を更新できませんでした。';
	@override String get error_generic => '問題が発生しました。再試行してください。';
	@override String get empty_results => '生成結果はまだありません。';
	@override String get prompt_missing_fallback => 'プロンプトのプレビューがありません。';
...
extension on TranslationsJa {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'coordinate.coordinate_page_title' => 'コーディネート',
			'coordinate.coordinate_page_subtitle' => '参照画像ベースで生成し、進行状況をリアルタイムで確認できます。',
			'coordinate.generation_section_title' => '生成',
			'coordinate.results_section_title' => '生成結果',
			'coordinate.progress_section_title' => '生成進行',
			'coordinate.source_mode_upload' => 'アップロード',
			'coordinate.source_mode_stock' => 'ストック',
			'coordinate.upload_library_title' => 'ソース画像アップロード',
			'coordinate.upload_library_action' => 'ライブラリから選択',
			'coordinate.upload_library_loading' => 'ライブラリを開いています...',
			'coordinate.upload_none_selected' => 'アップロード未選択',
			'coordinate.stock_picker_title' => 'ストック画像を選択',
			'coordinate.prompt_input_label' => 'プロンプト',
			'coordinate.prompt_input_hint' => '生成したい衣装・スタイル変更内容を入力してください',
			'coordinate.source_type_label' => 'ソース画像タイプ',
			'coordinate.source_type_illustration' => 'イラスト',
			'coordinate.source_type_real' => '実写',
			'coordinate.background_label' => '背景モード',
			'coordinate.background_keep' => '背景を維持',
			'coordinate.background_include' => '背景をプロンプトに含める',
			'coordinate.background_auto' => 'AI自動背景',
			'coordinate.model_tier_label' => '生成モデルを選択',
			'coordinate.model_tier_light' => '軽量モデル：Nano Banana 2 | 0.5K（10ペルコイン/枚）',
			'coordinate.model_tier_standard' => '標準モデル：Nano Banana 2 | 1K（20ペルコイン/枚）',
			'coordinate.model_tier_pro1k' => '高精細モデル：Nano Banana Pro | 1K（50ペルコイン/枚）',
			'coordinate.model_tier_pro2k' => '高精細モデル：Nano Banana Pro | 2K（80ペルコイン/枚）',
			'coordinate.model_tier_pro4k' => '高精細モデル：Nano Banana Pro | 4K（100ペルコイン/枚）',
			'coordinate.output_count_label' => '出力枚数',
			'coordinate.estimated_cost_label' => '想定コスト: {{amount}} percoins • 残高: {{balance}}',
			'coordinate.plan_limit_notice' => '現在のプランでは1回の生成で最大{{max}}枚までです。',
			'coordinate.generating_button_ready' => '生成する',
			'coordinate.generating_button_loading' => '生成中...',
			'coordinate.balance_chip' => '残高: {{amount}}',
			'coordinate.buy_percoins_action' => 'Percoinsを購入',
			'coordinate.still_processing_notice' => 'バックグラウンドで処理中です。Coordinateを再表示すると自動で追跡を再開します。',
			'coordinate.status_queued' => 'キュー待ち',
			'coordinate.status_processing' => '処理中',
			'coordinate.status_charging' => '課金処理中',
			'coordinate.status_generating' => '画像生成中',
			'coordinate.status_uploading' => 'アップロード中',
			'coordinate.status_persisting' => '保存中',
			'coordinate.status_completed' => '完了',
			'coordinate.status_failed' => '失敗',
			'coordinate.error_missing_prompt' => '生成前にプロンプトを入力してください。',
			'coordinate.error_prompt_too_long' => 'プロンプトが上限を超えています。',
			'coordinate.error_missing_source' => '生成前にソース画像を選択してください。',
			'coordinate.error_unsupported_upload' => 'アップロード対応形式は JPG/PNG/WebP のみです。',
			'coordinate.error_upload_too_large' => 'アップロードサイズは10MB以下にしてください。',
			'coordinate.error_upgrade_required' => '選択した枚数は現在のプラン上限を超えています。',
			'coordinate.error_insufficient_balance' => 'このリクエストに必要な percoins が不足しています。',
			'coordinate.error_submit_failed' => '現在生成リクエストを送信できません。',
			'coordinate.error_history_failed' => '生成履歴を読み込めませんでした。',
			'coordinate.error_polling_failed' => '生成進捗を更新できませんでした。',
			'coordinate.error_generic' => '問題が発生しました。再試行してください。',
			'coordinate.empty_results' => '生成結果はまだありません。',
			'coordinate.prompt_missing_fallback' => 'プロンプトのプレビューがありません。',
